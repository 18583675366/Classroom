...
public class SendMailDemo {
	public static void main(String[] args) {
		...
		// 邮箱用户名
		mailInfo.setUserName("15884243772@163.com");
		// 邮箱密码
		mailInfo.setPassword("realcare3226.097");
		// 发件人邮箱
		mailInfo.setFromAddress("15884243772@163.com");
		// 收件人邮箱
		mailInfo.setToAddress("120370694@qq.com");
		// 邮件标题
