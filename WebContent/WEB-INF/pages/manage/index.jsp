...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/style/chart/raphael.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/style/chart/g.raphael.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/style/chart/g.bar.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/style/chart/g.line.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/style/chart/g.pie.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/style/chart/g.dot.js"></script>

<script src="${pageContext.request.contextPath}/style/js/dwz.min.js"
	type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/style/js/dwz.regional.zh.js" type="text/javascript"></script>
							...
							<li><a href="tabsPage.html" target="navTab">主框架面板</a>
								<ul>
									...
									<li><a href="http://www.baidu.com" target="navTab"
										rel="page1">页面一(外部链接)</a></li>
									<li><a href="demo/baidu_map.html" target="navTab"
										rel="external" external="true" title="需要设置external属性为true">地图(external="true")</a></li>
