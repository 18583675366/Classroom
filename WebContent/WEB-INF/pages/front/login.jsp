				...
				<div class="form">
					<form action="#" method="post">
						...
						<div class="form-group">
							<div class="col-xs-5  ">
								<div class="input-group">
									<span class="input-group-addon"><span
										class="glyphicon glyphicon-lock"></span></span> <input type="text"
										id="code" name="code" class="form-control" placeholder="验证码"
										style="width: 50% px;"> </input>
								</div>
							</div>
							<div class="col-xs-5  ">
								<img src="${pageContext.request.contextPath}/code/img"></img>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-5 link">
								<p class="text-center remove-margin">
									<small>还没注册?</small> <a href="${pageContext.request.contextPath}/user/registerUI"><small>注册</small></a>
								</p>
							</div>
							<div class="col-xs-2 link">
								<p class="text-center remove-margin">
									 <a href="javascript:void(0)"><small>qq登录</small></a>
								</p>
							</div>
						</div>
					</form>
